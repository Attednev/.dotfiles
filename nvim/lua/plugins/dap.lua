return {
    ...
    keys = {
        { "<F10>", function() require("dap").set_breakpoint(vim.fn.input("Breakpoint condition: ")) end, desc = "Debug: Conditional Breakpoint" },
        ...
        { "<F6>", function() require("dap").set_breakpoint(nil, nil, vim.fn.input("Log point message: ")) end, desc = "Debug: Log Point" },
        { "<F5>", function() require("dap").continue() end, desc = "Debug: Continue" },
        { "<S-F5>", function() require("dap").restart() end, desc = "Debug: Restart" },
